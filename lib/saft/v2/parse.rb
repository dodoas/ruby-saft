        ...
        when Types::HeaderStructure.name
          {
            ...
            company: parse(Types::CompanyHeaderStructure, xml.at_xpath("Company")),
            default_currency_code: xml.at_xpath("DefaultCurrencyCode")&.content,
            selection_criteria: parse(Types::SelectionCriteriaStructure, xml.at_xpath("SelectionCriteria")&.content),
            header_comment: xml.at_xpath("HeaderComment")&.content,
          }
        ...
        when Types::MasterFiles.name
          {
            ...
            analysis_type_table: xml.xpath("AnalysisTypeTable/AnalysisTypeTableEntry").map { |node| parse(Types::AnalysisTypeTableEntry, node) }.then { _1.empty? ? nil : _1 },
